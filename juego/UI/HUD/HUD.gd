...
onready var info_zona_recarga:ContenedorInformacion = $InfoZonaRegarga
...
func conectar_seniales()->void:
	...
	Eventos.connect("cambio_energia_escudo",self,"_on_actualizar_energia_escucdo")
	Eventos.connect("ocultar_energia_escudo",info_laser,"ocultar")
...
func _on_actualizar_energia_laser(energian_max:float,energia_actual:float)->void:
	info_laser.mostrar()
